...
{/* 
adding the article and other stuff */}
...
{/* adding the video ajnd the other section */}
<section>
<div className="flex-container grid grid-cols-2  ">
  
   
    <iframe
  width="640"
  height="500"
  src="https://www.youtube.com/embed/My2FRPA3Gf8&list=PLSTz8jpJdr5qYuDObWzZzO42kHXY8WPeg"
  frameBorder="0"
  allowFullScreen
></iframe>
<div>
